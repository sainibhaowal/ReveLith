...
// ---- AI provider settings/config/streaming: canonical types live in @revelith/ai-provider ----
...
import type { FaceVerticalMetrics } from '@revelith/font-metrics'
...
// ---- agent protocol: canonical types live in @revelith/agent-core ----
...
export interface DesktopApi {
  ...
  /** shared AI settings changed elsewhere (for example Shell Settings) */
