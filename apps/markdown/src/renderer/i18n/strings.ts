export const strings = {
  zh: {
    ...
    aiCreditsExhausted: '积分不足，请前往 revelith.ai 充值',
  ...
  en: {
    ...
    aiCreditsExhausted: 'Out of credits : top up at revelith.ai',
  ...
  ja: {
    ...
    aiCreditsExhausted: 'クレジット不足です。revelith.ai でチャージしてください',
  ...
  ko: {
    ...
    aiCreditsExhausted: '크레딧이 부족합니다. revelith.ai에서 충전하세요',
  ...
  fr: {
    ...
    aiCreditsExhausted: 'Crédits épuisés : rechargez sur revelith.ai',
  ...
  id: {
    ...
    aiCreditsExhausted: 'Kredit habis : isi ulang di revelith.ai',
  ...
  ru: {
    ...
    aiCreditsExhausted: 'Кредиты закончились : пополните на revelith.ai',
  ...
  ar: {
    ...
    aiCreditsExhausted: 'نفدت الأرصدة : أعد الشحن على revelith.ai',
  ...
  pl: {
    ...
    aiCreditsExhausted: 'Brak kredytów : doładuj na revelith.ai',
  ...
  he: {
    ...
    aiCreditsExhausted: 'נגמרו הקרדיטים : טענו ב-revelith.ai',
  ...
  hi: {
    ...
    aiCreditsExhausted: 'क्रेडिट समाप्त : revelith.ai पर रिचार्ज करें',
  ...
  'zh-TW': {
    ...
    aiCreditsExhausted: '點數不足，請前往 revelith.ai 儲值',
