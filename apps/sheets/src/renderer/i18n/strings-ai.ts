...
export const aiStrings = defineStrings({
  zh: {
    ...
    aiReveLithAccount: 'ReveLith 账号',
    aiAccountChecking: '检测中…',
    aiLoggedIn: '已登录',
    aiLoggedInAs: '已登录：{email}',
    aiNotLoggedIn: '未登录（AI 功能需要登录 ReveLith 账号）',
    aiWaitingBrowserLogin: '等待浏览器登录…',
    aiLoginReveLith: '登录 ReveLith',
    aiModel: '模型',
    aiCancel: '取消',
    aiSave: '保存',
    aiUnknownError: '未知错误',
  ...
  en: {
    ...
    aiUndelivered: 'Not delivered — the AI provider did not process this prompt. You can retry it.',
    aiRetry: 'Retry',
    ...
    aiReveLithAccount: 'ReveLith account',
    aiAccountChecking: 'Checking…',
    aiLoggedIn: 'Signed in',
    aiLoggedInAs: 'Signed in: {email}',
    aiNotLoggedIn: 'Not signed in (AI features require a ReveLith account)',
    aiWaitingBrowserLogin: 'Waiting for browser sign-in…',
    aiLoginReveLith: 'Sign in to ReveLith',
    aiModel: 'Model',
    aiCancel: 'Cancel',
    aiSave: 'Save',
  ...
  ja: {
    ...
    aiReveLithAccount: 'ReveLith アカウント',
    aiAccountChecking: '確認中…',
    aiLoggedIn: 'サインイン済み',
    aiLoggedInAs: 'サインイン済み: {email}',
    aiNotLoggedIn: '未サインイン（AI 機能には ReveLith アカウントへのサインインが必要です）',
    aiWaitingBrowserLogin: 'ブラウザーでのサインインを待機中…',
    aiLoginReveLith: 'ReveLith にサインイン',
    aiModel: 'モデル',
    aiCancel: 'キャンセル',
    aiSave: '保存',
  ...
  ko: {
    ...
    aiReveLithAccount: 'ReveLith 계정',
    aiAccountChecking: '확인 중…',
    aiLoggedIn: '로그인됨',
    aiLoggedInAs: '로그인됨: {email}',
    aiNotLoggedIn: '로그인되지 않음(AI 기능을 사용하려면 ReveLith 계정 로그인이 필요합니다)',
    aiWaitingBrowserLogin: '브라우저 로그인 대기 중…',
    aiLoginReveLith: 'ReveLith 로그인',
    aiModel: '모델',
    aiCancel: '취소',
    aiSave: '저장',
  ...
  fr: {
    ...
    aiReveLithAccount: 'Compte ReveLith',
    aiAccountChecking: 'Vérification…',
    aiLoggedIn: 'Connecté',
    aiLoggedInAs: 'Connecté : {email}',
    aiNotLoggedIn: 'Non connecté (les fonctions IA nécessitent un compte ReveLith)',
    aiWaitingBrowserLogin: 'En attente de la connexion dans le navigateur…',
    aiLoginReveLith: 'Se connecter à ReveLith',
    aiModel: 'Modèle',
    aiCancel: 'Annuler',
    aiSave: 'Enregistrer',
  ...
  de: {
    ...
    aiReveLithAccount: 'ReveLith-Konto',
    aiAccountChecking: 'Wird überprüft…',
    aiLoggedIn: 'Angemeldet',
    aiLoggedInAs: 'Angemeldet: {email}',
    aiNotLoggedIn: 'Nicht angemeldet (KI-Funktionen erfordern ein ReveLith-Konto)',
    aiWaitingBrowserLogin: 'Warten auf Anmeldung im Browser…',
    aiLoginReveLith: 'Bei ReveLith anmelden',
    aiModel: 'Modell',
    aiCancel: 'Abbrechen',
    aiSave: 'Speichern',
  ...
  es: {
    ...
    aiReveLithAccount: 'Cuenta de ReveLith',
    aiAccountChecking: 'Comprobando…',
    aiLoggedIn: 'Sesión iniciada',
    aiLoggedInAs: 'Sesión iniciada: {email}',
    aiNotLoggedIn: 'Sin sesión iniciada (las funciones de IA requieren una cuenta de ReveLith)',
    aiWaitingBrowserLogin: 'Esperando el inicio de sesión en el navegador…',
    aiLoginReveLith: 'Iniciar sesión en ReveLith',
    aiModel: 'Modelo',
    aiCancel: 'Cancelar',
    aiSave: 'Guardar',
  ...
  ru: {
    ...
    aiReveLithAccount: 'Учётная запись ReveLith',
    aiAccountChecking: 'Проверка…',
    aiLoggedIn: 'Вход выполнен',
    aiLoggedInAs: 'Вход выполнен: {email}',
    aiNotLoggedIn: 'Вход не выполнен (для функций ИИ требуется учётная запись ReveLith)',
    aiWaitingBrowserLogin: 'Ожидание входа в браузере…',
    aiLoginReveLith: 'Войти в ReveLith',
    aiModel: 'Модель',
    aiCancel: 'Отмена',
    aiSave: 'Сохранить',
  ...
  ar: {
    ...
    aiReveLithAccount: 'حساب ReveLith',
    aiAccountChecking: 'جارٍ التحقق…',
    aiLoggedIn: 'تم تسجيل الدخول',
    aiLoggedInAs: 'تم تسجيل الدخول: {email}',
    aiNotLoggedIn: 'لم يتم تسجيل الدخول (تتطلب ميزات الذكاء الاصطناعي حساب ReveLith)',
    aiWaitingBrowserLogin: 'في انتظار تسجيل الدخول من المتصفح…',
    aiLoginReveLith: 'تسجيل الدخول إلى ReveLith',
    aiModel: 'النموذج',
    aiCancel: 'إلغاء',
    aiSave: 'حفظ',
  ...
  pt: {
    ...
    aiReveLithAccount: 'Conta ReveLith',
    aiAccountChecking: 'Verificando…',
    aiLoggedIn: 'Conectado',
    aiLoggedInAs: 'Conectado: {email}',
    aiNotLoggedIn: 'Não conectado (os recursos de IA exigem uma conta ReveLith)',
    aiWaitingBrowserLogin: 'Aguardando login no navegador…',
    aiLoginReveLith: 'Entrar no ReveLith',
    aiModel: 'Modelo',
    aiCancel: 'Cancelar',
    aiSave: 'Salvar',
  ...
  nl: {
    ...
    aiNotLoggedIn: 'Niet aangemeld (AI-functies vereisen een ReveLith-account)',
    aiWaitingBrowserLogin: 'Wachten op aanmelding in de browser…',
    aiLoginReveLith: 'Aanmelden bij ReveLith',
    aiModel: 'Model',
    aiCancel: 'Annuleren',
    aiSave: 'Opslaan',
  ...
  he: {
    ...
    aiReveLithAccount: 'חשבון ReveLith',
    aiAccountChecking: 'בודק…',
    aiLoggedIn: 'מחובר',
    aiLoggedInAs: 'מחובר: {email}',
    aiNotLoggedIn: 'לא מחובר (תכונות AI דורשות חשבון ReveLith)',
    aiWaitingBrowserLogin: 'ממתין לכניסה בדפדפן…',
    aiLoginReveLith: 'כניסה ל-ReveLith',
    aiModel: 'מודל',
    aiCancel: 'ביטול',
    aiSave: 'שמירה',
  ...
  hi: {
    ...
    aiReveLithAccount: 'ReveLith खाता',
    aiAccountChecking: 'जांच हो रही है…',
    aiLoggedIn: 'साइन इन किया गया',
    aiLoggedInAs: 'साइन इन: {email}',
    aiNotLoggedIn: 'साइन इन नहीं है (AI सुविधाओं के लिए ReveLith खाता आवश्यक है)',
    aiWaitingBrowserLogin: 'ब्राउज़र में साइन इन की प्रतीक्षा…',
    aiLoginReveLith: 'ReveLith में साइन इन करें',
    aiModel: 'मॉडल',
    aiCancel: 'रद्द करें',
    aiSave: 'सहेजें',
  ...
  'zh-TW': {
    ...
    aiReveLithAccount: 'ReveLith 帳號',
    aiAccountChecking: '偵測中…',
    aiLoggedIn: '已登入',
    aiLoggedInAs: '已登入：{email}',
    aiNotLoggedIn: '未登入（AI 功能需要登入 ReveLith 帳號）',
    aiWaitingBrowserLogin: '等待瀏覽器登入…',
    aiLoginReveLith: '登入 ReveLith',
    aiModel: '模型',
    aiCancel: '取消',
    aiSave: '儲存',
    aiUnknownError: '未知錯誤',
