...
export interface HomeApi {
  ...
  /** open the ReveLith community page in the default browser */
  openCommunity(): Promise<void>
  /** get AI settings configuration */
  getAiSettings?(): Promise<any>
  /** set AI settings configuration */
...
export const HOME_CHANNELS = {
  ...
  discoverAiModels: 'home:discover-ai-models',
  setSettingsOverlay: 'home:set-settings-overlay',
} as const
