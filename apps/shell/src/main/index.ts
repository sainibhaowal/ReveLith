...
const tMain = createI18n({
  zh: {
    ...
    pdfDocxLoginMsg: '导出为 Word 需要登录 ReveLith AI 账号。',
    pdfDocxLoginDetail: '点击“登录”将打开浏览器完成授权，完成后请重新点击导出。',
    pdfDocxBtnLogin: '登录',
    pdfDocxConfirmMsg: '将此 PDF 上传到 ReveLith AI 云端转换为 Word？',
    ...
    pdfDocxNoCliMsg: '无法登录 ReveLith AI：缺少必需组件（account），请重新安装应用。',
  ...
  en: {
    ...
    pdfDocxLoginMsg: 'Exporting as Word requires signing in to ReveLith AI.',
    pdfDocxLoginDetail:
      'Clicking “Sign In” opens your browser to authorize; once done, click Export again.',
    pdfDocxBtnLogin: 'Sign In',
    pdfDocxConfirmMsg: 'Upload this PDF to ReveLith AI cloud and convert it to Word?',
    ...
    pdfDocxNoCliMsg:
      'Cannot sign in to ReveLith AI: a required component (account) is missing. Please reinstall the app.',
  ...
  ja: {
    ...
    pdfDocxLoginMsg: 'Word への書き出しには ReveLith AI へのログインが必要です。',
    pdfDocxLoginDetail:
      '「ログイン」をクリックするとブラウザで認証します。完了後、もう一度書き出しを実行してください。',
    pdfDocxBtnLogin: 'ログイン',
    pdfDocxConfirmMsg: 'この PDF を ReveLith AI クラウドにアップロードして Word に変換しますか？',
    pdfDocxConfirmDetail:
    ...
    pdfDocxNoCliMsg:
      'ReveLith AI にサインインできません：必要なコンポーネント（account）が見つかりません。アプリを再インストールしてください。',
  ...
  ko: {
    ...
    pdfDocxLoginMsg: 'Word로 내보내려면 ReveLith AI 로그인이 필요합니다.',
    pdfDocxLoginDetail:
      '“로그인”을 클릭하면 브라우저에서 인증합니다. 완료 후 내보내기를 다시 클릭하세요.',
    pdfDocxBtnLogin: '로그인',
    pdfDocxConfirmMsg: '이 PDF를 ReveLith AI 클라우드에 업로드하여 Word로 변환할까요?',
    pdfDocxConfirmDetail:
    ...
    pdfDocxNoCliMsg:
      'ReveLith AI에 로그인할 수 없습니다. 필수 구성 요소(account)가 없습니다. 앱을 다시 설치해 주세요.',
  ...
  fr: {
    ...
    pdfDocxLoginMsg: "L'export en Word nécessite une connexion à ReveLith AI.",
    pdfDocxLoginDetail:
      "Cliquez sur « Se connecter » pour autoriser dans le navigateur, puis relancez l'export.",
    pdfDocxBtnLogin: 'Se connecter',
    pdfDocxConfirmMsg: 'Téléverser ce PDF vers le cloud ReveLith AI pour le convertir en Word ?',
    pdfDocxConfirmDetail:
    ...
    pdfDocxNoCliMsg:
      "Connexion à ReveLith AI impossible : un composant requis (account) est manquant. Veuillez réinstaller l'application.",
  ...
  de: {
    ...
    pdfDocxLoginMsg: 'Für den Word-Export ist eine Anmeldung bei ReveLith AI erforderlich.',
    pdfDocxLoginDetail:
    ...
    pdfDocxConfirmMsg: 'Dieses PDF in die ReveLith AI Cloud hochladen und in Word konvertieren?',
    pdfDocxConfirmDetail:
    ...
    pdfDocxNoCliMsg:
      'Anmeldung bei ReveLith AI nicht möglich: Eine erforderliche Komponente (account) fehlt. Bitte installieren Sie die App neu.',
  ...
  es: {
    ...
    pdfDocxLoginMsg: 'Para exportar como Word es necesario iniciar sesión en ReveLith AI.',
    pdfDocxLoginDetail:
    ...
    pdfDocxConfirmMsg: '¿Subir este PDF a la nube de ReveLith AI para convertirlo a Word?',
    pdfDocxConfirmDetail:
    ...
    pdfDocxNoCliMsg:
      'No se puede iniciar sesión en ReveLith: falta un componente necesario (account). Reinstale la aplicación.',
  ...
  th: {
    ...
    pdfDocxLoginMsg: 'การส่งออกเป็น Word ต้องเข้าสู่ระบบ ReveLith AI',
    pdfDocxLoginDetail:
      'คลิก “เข้าสู่ระบบ” เพื่อเปิดเบราว์เซอร์ยืนยันตัวตน เสร็จแล้วให้คลิกส่งออกอีกครั้ง',
    pdfDocxBtnLogin: 'เข้าสู่ระบบ',
    pdfDocxConfirmMsg: 'อัปโหลด PDF นี้ไปยังคลาวด์ ReveLith AI เพื่อแปลงเป็น Word หรือไม่?',
    ...
    pdfDocxNoCliMsg:
      'ไม่สามารถลงชื่อเข้าใช้ ReveLith AI ได้: ไม่พบคอมโพเนนต์ที่จำเป็น (account) โปรดติดตั้งแอปใหม่',
  ...
  id: {
    ...
    pdfDocxLoginMsg: 'Ekspor sebagai Word memerlukan login ke ReveLith AI.',
    pdfDocxLoginDetail:
      'Klik “Masuk” untuk membuka browser dan memberi otorisasi; setelah selesai, klik Ekspor lagi.',
    pdfDocxBtnLogin: 'Masuk',
    pdfDocxConfirmMsg: 'Unggah PDF ini ke cloud ReveLith AI untuk dikonversi ke Word?',
    pdfDocxConfirmDetail:
    ...
    pdfDocxNoCliMsg:
      'Tidak dapat masuk ke ReveLith AI: komponen yang diperlukan (account) tidak ditemukan. Silakan instal ulang aplikasi.',
  ...
  ru: {
    ...
    pdfDocxLoginMsg: 'Для экспорта в Word требуется вход в ReveLith AI.',
    pdfDocxLoginDetail:
      'Нажмите «Войти», чтобы авторизоваться в браузере, затем снова запустите экспорт.',
    pdfDocxBtnLogin: 'Войти',
    pdfDocxConfirmMsg: 'Загрузить этот PDF в облако ReveLith AI и конвертировать в Word?',
    pdfDocxConfirmDetail:
    ...
    pdfDocxNoCliMsg:
      'Не удаётся войти в ReveLith AI: отсутствует необходимый компонент (account). Переустановите приложение.',
  ...
  ar: {
    ...
    pdfDocxLoginMsg: 'يتطلب التصدير كملف Word تسجيل الدخول إلى ReveLith AI.',
    pdfDocxLoginDetail:
      'انقر على «تسجيل الدخول» لفتح المتصفح وإتمام التفويض، ثم انقر على التصدير مرة أخرى.',
    pdfDocxBtnLogin: 'تسجيل الدخول',
    pdfDocxConfirmMsg: 'رفع هذا الـ PDF إلى سحابة ReveLith AI وتحويله إلى Word؟',
    ...
    pdfDocxNoCliMsg:
      'تعذّر تسجيل الدخول إلى ReveLith AI: المكوّن المطلوب (account) مفقود. يُرجى إعادة تثبيت التطبيق.',
  ...
  pt: {
    ...
    menuExportDocx: 'Exportar como Word…',
    pdfDocxLoginMsg: 'Exportar como Word requer login no ReveLith AI.',
    pdfDocxLoginDetail:
      'Clique em “Entrar” para autorizar no navegador; depois, clique em Exportar novamente.',
    pdfDocxBtnLogin: 'Entrar',
    pdfDocxConfirmMsg: 'Enviar este PDF para a nuvem do ReveLith AI e convertê-lo em Word?',
    pdfDocxConfirmDetail:
    ...
    pdfDocxNoCliMsg:
      'Não é possível iniciar sessão no ReveLith AI: falta um componente necessário (account). Reinstale o aplicativo.',
  ...
  it: {
    ...
    pdfDocxLoginMsg: 'Per esportare come Word è necessario accedere a ReveLith AI.',
    pdfDocxLoginDetail:
      'Fai clic su “Accedi” per autorizzare nel browser; al termine, fai di nuovo clic su Esporta.',
    pdfDocxBtnLogin: 'Accedi',
    pdfDocxConfirmMsg: 'Caricare questo PDF sul cloud ReveLith AI e convertirlo in Word?',
    pdfDocxConfirmDetail:
    ...
    pdfDocxNoCliMsg:
      "Impossibile accedere a ReveLith AI: manca un componente necessario (account). Reinstallare l'app.",
  ...
  pl: {
    ...
    pdfDocxLoginMsg: 'Eksport do formatu Word wymaga zalogowania do ReveLith AI.',
    pdfDocxLoginDetail:
      'Kliknij „Zaloguj się”, aby autoryzować w przeglądarce; po zakończeniu kliknij Eksportuj ponownie.',
    pdfDocxBtnLogin: 'Zaloguj się',
    pdfDocxConfirmMsg: 'Przesłać ten PDF do chmury ReveLith AI i przekonwertować na Word?',
    pdfDocxConfirmDetail:
    ...
    pdfDocxNoCliMsg:
      'Nie można zalogować się do ReveLith AI: brakuje wymaganego komponentu (account). Zainstaluj aplikację ponownie.',
  ...
  nl: {
    ...
    pdfDocxLoginMsg: 'Exporteren als Word vereist inloggen bij ReveLith.',
    pdfDocxLoginDetail:
      'Klik op “Inloggen” om in de browser te autoriseren; klik daarna opnieuw op Exporteren.',
    pdfDocxBtnLogin: 'Inloggen',
    pdfDocxConfirmMsg: 'Deze PDF uploaden naar de ReveLith-cloud en converteren naar Word?',
    pdfDocxConfirmDetail:
    ...
    pdfDocxNoCliMsg:
      'Kan niet inloggen bij ReveLith: een vereist onderdeel (account) ontbreekt. Installeer de app opnieuw.',
  ...
  ms: {
    ...
    pdfDocxLoginMsg: 'Eksport sebagai Word memerlukan log masuk ke ReveLith AI.',
    pdfDocxLoginDetail:
    ...
    pdfDocxConfirmMsg: 'Muat naik PDF ini ke awan ReveLith untuk ditukar kepada Word?',
    pdfDocxConfirmDetail:
    ...
    pdfDocxNoCliMsg:
      'Tidak dapat log masuk ke ReveLith AI: komponen yang diperlukan (account) tiada. Sila pasang semula aplikasi.',
  ...
  he: {
    ...
    pdfDocxLoginMsg: 'ייצוא כ-Word דורש התחברות ל-ReveLith.',
    pdfDocxLoginDetail: 'לחיצה על ”התחברות” תפתח את הדפדפן לאישור; בסיום, לחצו שוב על ייצוא.',
    pdfDocxBtnLogin: 'התחברות',
    pdfDocxConfirmMsg: 'להעלות את ה-PDF לענן של ReveLith ולהמיר אותו ל-Word?',
  ...
  hi: {
    ...
    pdfDocxLoginMsg: 'Word के रूप में निर्यात करने के लिए ReveLith में लॉगिन आवश्यक है।',
    pdfDocxLoginDetail:
      '“लॉगिन” पर क्लिक करने से ब्राउज़र में प्राधिकरण खुलेगा; पूरा होने पर फिर से निर्यात पर क्लिक करें।',
    pdfDocxBtnLogin: 'लॉगिन',
    pdfDocxConfirmMsg: 'इस PDF को ReveLith क्लाउड पर अपलोड करके Word में बदलें?',
    pdfDocxConfirmDetail:
    ...
    pdfDocxNoCliMsg:
      'ReveLith में साइन इन नहीं किया जा सकता: आवश्यक घटक (account) मौजूद नहीं है। कृपया ऐप को फिर से इंस्टॉल करें।',
  ...
  'zh-TW': {
    ...
    pdfDocxLoginMsg: '匯出為 Word 需要登入 ReveLith 帳號。',
    pdfDocxLoginDetail: '點擊「登入」將開啟瀏覽器完成授權，完成後請重新點擊匯出。',
    pdfDocxBtnLogin: '登入',
    pdfDocxConfirmMsg: '將此 PDF 上傳到 ReveLith 雲端轉換為 Word？',
    ...
    pdfDocxNoCliMsg: '無法登入 ReveLith AI：缺少必要元件（account），請重新安裝應用程式。',
...
function registerHomeIpc(): void {
  ipcMain.handle(HOME_CHANNELS.setSettingsOverlay, (_event, open: unknown) => {
    tabManager?.setShellOverlayOpen(open === true)
  })
 ...
 * pick the destination, then upload + cloud-convert via account file_convert. Not
...
async function exportPdfAsDocx(): Promise<void> {
  ...
  try {
    void dialog.showMessageBox(shellWindow, {
      type: 'info',
      message: 'Cloud PDF conversion is disabled. Use a local converter or export workflow.',
    })
  } catch (err) {
...
async function installMainProcessProxy(): Promise<void> {
  ...
  if (!proxyUrl) {
    try {
      ...
      // ReveLith LLM proxy and the account CLI actually target
  ...
  if (!proxyUrl) return
  // spawned account CLI children (login/search/…) do their own fetch and never see
