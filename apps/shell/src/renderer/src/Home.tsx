...
function formatModified(mtimeMs: number, i18n: I18n): string {
  ...
  if (days <= 0) {
    return `${i18n.t('today')} Â· ${date.toLocaleTimeString(i18n.dateLocale, { hour: '2-digit', minute: '2-digit' })}`
  }
...
export function Home() {
  ...
  // â”€â”€ Project files state â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€ Plain view (no project selected): filtering runs in the main process; entries is the visible list â”€â”€
      ...
      <div className="quick-cards">
        {NEW_ITEMS.map((item) => (
          <button key={item.ext} className="quick-card" onClick={() => void item.action()}>
            <div className="quick-icon-wrapper">
              <FileBadge ext={item.ext} size={32} />
            </div>
            <span className="quick-text">
              <span className="quick-title-row">
                <span className="quick-title">
                  {item.title} <span style={{ color: '#3b82f6', fontWeight: 600 }}>Ai</span>
                </span>
              </span>
        ...
        <button className="quick-card quick-card-browse" onClick={() => void window.aiOffice.browse()}>
          ...
          <span className="quick-text">
            ...
            <span className="quick-sub">.docx Â· .xlsx Â· .pptx Â· .pdf Â· .md</span>
          </span>
        </button>
      </div>
    )
  ...
  // â”€â”€ File row rendering (shared by the plain view and the project files view) â”€â”€
  ...
  // â”€â”€ Project files view â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€ Plain view â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      ...
      <aside className="sidebar">
        <div className="sidebar-logo brand-header">
          ...
          <div className="brand-info">
            <span className="brand-title">ReveLith</span>
            <span className="brand-subtitle">OFFICE WORKSPACE</span>
          </div>
        </div>
