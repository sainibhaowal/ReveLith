...
// These cases only test the Serper/DuckDuckGo paths; a local account login would take priority, so disable it explicitly
beforeAll(() => {
  process.env.AI_SEARCH_DISABLE_REVELITH = '1'
})
